...
u_0 = -13
delta_u_0 = 7.
u_surf = Expression('u_0 + delta_u_0 * sin(2 * pi / period * t)',
                    u_0=u_0, delta_u_0=delta_u_0, period=period, t=t_a)
u_base = Constant('-13.')
...
t = t_a
u_exact = Expression('u_0 + delta_u_0 * exp(-x[0] * sqrt(2*pi/(2*kappa))) 
* sin(2 * pi / period * t -x[0] * sqrt(2 * pi/(2 * kappa)))', 
